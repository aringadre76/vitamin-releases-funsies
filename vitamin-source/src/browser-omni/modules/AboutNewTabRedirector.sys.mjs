...
class BaseAboutNewTabRedirector {
   ...
   */
  get defaultURL() {
    // Vitamin Browser: Use custom start page
    return "chrome://browser/content/vitamin-newtab.html";
  }
  ...
  getChromeURI() {
    return Services.io.newURI("chrome://browser/content/vitamin-newtab.html");
  }
